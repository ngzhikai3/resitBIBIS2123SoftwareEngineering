  ...
  <br />
  <div class="w3-card-2 w3-round w3-white w3-center">
    <a href="../search-projects.php"><button class="w3-btn-block bg-primary w3-left-align" onclick=""><i class="fa fa-search fa-fw w3-margin-right"></i>Projects Archieve</button></a>
  </div>
  <br />
